...
aboutHelpFooter?.insertAdjacentHTML('beforeend','<a href="disclaimer.html">Disclaimer</a>');
...
const aboutFooterRoutes={'about us':'about.html','contact us':'contact.html','faq’s':'faq.html','faq':'faq.html','blog':'blog.html','shipping policy':'shipping-policy.html','return & refund policy':'return-policy.html','terms & conditions':'terms.html','privacy policy':'privacy-policy.html','help center':'help-center.html','disclaimer':'disclaimer.html'};
document.querySelectorAll('.site-footer a').forEach(link=>{const href=aboutFooterRoutes[link.textContent.trim().toLowerCase()];if(href)link.href=href});
